                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.videos.update', $video) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('title', $video->title) }}" required autofocus>
                        </div>

                        <!-- Description -->
                        <div class="mb-4">
                            <label for="description" class="block font-medium text-sm text-gray-700">Description</label>
                            <textarea name="description" id="description" rows="4" class="block mt-1 w-full rounded-md shadow-sm border-gray-300">{{ old('description', $video->description) }}</textarea>
                        </div>

                        <!-- Thumbnail URL -->
                        <div class="mb-4">
                            <label for="thumbnail_url" class="block font-medium text-sm text-gray-700">Thumbnail URL</label>
                            <input type="url" name="thumbnail_url" id="thumbnail_url" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('thumbnail_url', $video->thumbnail_url) }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="video_type" id="video_type" class="block mt-1 w-full rounded-md shadow-sm border-gray-300">
                                ...
                                <option value="direct" {{ old('video_type', $video->video_type) == 'direct' ? 'selected' : '' }}>Direct URL (.mp4, etc)</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="video_url" id="video_url" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('video_url', $video->video_url) }}" required>
